...
MStatus ExportHairCommand::doIt(const MArgList &args) {
    MStatus status;
    std::string str;
...
ExportHairCommand::ExportHairCommand() {}
ExportHairCommand::~ExportHairCommand() {}

bool ExportHairCommand::isUndoable() const {
    return false;
}

void *ExportHairCommand::creator() {
    return new ExportHairCommand();
}